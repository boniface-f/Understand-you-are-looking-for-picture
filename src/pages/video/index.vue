...
<script>
	...
	import videoMain from "../components/video-main/index"
	import videoCategory from "../components/video-category/index"
	export default {
		data() {
			return {
				items: [
					{ title: "推荐",url:"http://157.122.54.189:9088/videoimg/v1/videowp/featured",params:{limit:18,skip:0,order:"hot"} },
					...
					{ title: "最新",url:"http://157.122.54.189:9088/videoimg/v1/videowp/videowp",params:{limit:18,skip:0,order:"new"} },
					{ title: "热门",url:"http://157.122.54.189:9088/videoimg/v1/videowp/videowp",params:{limit:18,skip:0,order:"hot"} },
